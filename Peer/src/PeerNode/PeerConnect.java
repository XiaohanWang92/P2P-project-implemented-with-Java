...
public class PeerConnect{
	private static int portNum;//=9000//this is peer 1's port number
	private static int neighborPort;//8705
	private static int listenPort;//8701
	...
	public static void main(String[] args) throws Exception{
		...
		shareFile.start();//sharing thread
