...
public class FileCombiner
{
	...
	public void combineFile() throws Exception{
		File eachFileOutput = new File(System.getProperty("user.dir")+File.separator+originalFileName);//establish file we want to combine
		...
		for(int i=1;i<fileNumber;i++){
			...
			RandomAccessFile partialRead=new RandomAccessFile(partRead, "r");//read chunk
