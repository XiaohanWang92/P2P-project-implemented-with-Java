...
Because the process is so quick, I use Scanner to wait some input from keyboard to separate and the start of peer download and upload threads, you can find more details by reading peer's main class method.
